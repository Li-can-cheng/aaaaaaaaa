            ...
            <el-col :lg="16" :md="20" :sm="24" :xs="24">
              <el-form :model="form" status-icon ref="form" label-width="100px" v-loading="loading"
                ...
                <el-form-item label="姓名" prop="name">
                  <el-input size="medium"  v-model="form.job_intention" placeholder="请填写姓名"></el-input>
                </el-form-item>
                ...
                <el-form-item label="邮箱" prop="email">
                  <el-input size="medium" v-model="form.age" placeholder="请填写邮箱"></el-input>
                </el-form-item>
                <el-form-item label="手机号" prop="phone">
                  <el-input size="medium" v-model="form.age" placeholder="请填写手机号"></el-input>
                </el-form-item>
